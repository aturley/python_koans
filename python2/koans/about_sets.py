...
class AboutSets(Koan):
    ...
    def test_sets_are_unordered(self):
        self.assertEqual(set(['2', '4', '1', '3', '5']), set('12345'))
    ...
    def test_set_have_arithmetic_operators(self):
        ...
        self.assertEqual(self.chars_in('cleod'), self.chars_in(good_guy - bad_guy))
        self.assertEqual(self.chars_in('macleodutns'), self.chars_in(good_guy | bad_guy))
        self.assertEqual(self.chars_in('ma'), self.chars_in(good_guy & bad_guy))
        self.assertEqual(self.chars_in('cleodutns'), self.chars_in(good_guy ^ bad_guy))
